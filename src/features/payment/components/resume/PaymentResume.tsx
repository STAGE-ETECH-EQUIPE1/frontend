...
export default function PaymentResume() {
  ...
  useEffect(() => {
    startTransition(async () => {
      await wait()
      const { success, data } =
        await paymentApi.getResumePaymentByReferenceAndTransactionId(
        ...
        <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
          <div className="receipt-container bg-white rounded-xl shadow-lg w-full max-w-2xl overflow-hidden">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-left border-b border-gray-200">
                      <th className="pb-2 text-gray-700 font-semibold">
                        Description
                      </th>
                      <th className="pb-2 text-gray-700 font-semibold text-right">
                        Quantity
                      </th>
                      <th className="pb-2 text-gray-700 font-semibold text-right">
                        Unit Price
            ...
            <div className="p-6 bg-gray-100 text-center text-gray-500 text-sm">
              ...
              <p className="mt-1">
                For any questions, please contact support@company.com
              </p>
            </div>
          </div>
