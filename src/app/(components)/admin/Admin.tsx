...
const mockPlans: Plan[] = [
  ...
  },
  {
    ...
    tokens: 100,
    maxTokens: 100,
    features: ["100 logos par mois", "Tous formats", "Support prioritaire", "API access"],
    isActive: true,
  ...
  },
  {
    ...
    tokens: "unlimited",
    maxTokens: "unlimited",
    features: ["Logos illimités", "Tous formats", "Support 24/7", "API access", "White-label"],
    isActive: true,
    subscribersCount: 89,
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
...
const mockFeedbacks: LogoFeedback[] = [
  {
    ...
    rating: 5,
    comment: "Excellent logo ! Exactement ce que je cherchais pour ma startup tech.",
    category: "Technology",
    style: "Modern",
    status: "approved",
  ...
  },
  {
    ...
    rating: 4,
    comment: "Très bon travail, quelques ajustements mineurs seraient parfaits.",
    category: "Design",
    style: "Creative",
    status: "pending",
  ...
  },
  {
    ...
    rating: 2,
    comment: "Le logo ne correspond pas vraiment à mes attentes. Trop générique.",
    category: "Business",
    style: "Professional",
    status: "rejected",
    adminResponse: "Nous prenons note de vos commentaires pour améliorer nos algorithmes.",
  ...
  },
  {
    ...
    rating: 5,
    comment: "Parfait pour notre agence ! Le style moderne et les couleurs sont top.",
    category: "Marketing",
    style: "Modern",
    status: "approved",
  ...
  },
  {
    ...
    rating: 3,
    comment: "Correct mais manque d'originalité. J'espérais quelque chose de plus unique.",
    category: "Technology",
    style: "Minimalist",
    status: "pending",
...
export function AdminPage() {
  ...
  const handleUpdateFeedback = (id: string, updates: Partial<LogoFeedback>) => {
    setFeedbacks((prev) => prev.map((feedback) => (feedback.id === id ? { ...feedback, ...updates } : feedback)))
  ...
  const handleCreatePlan = (plan: Omit<Plan, "id" | "createdAt" | "updatedAt" | "subscribersCount">) => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "dashboard":
        return <AdminDashboard users={users} plans={mockPlans} feedbacks={feedbacks} />
      case "plans":
        return (
          <PlansManagement
            plans={mockPlans}
  ...
  return (
    <SidebarProvider>
      <AdminSidebar admin={mockAdmin} activeTab={activeTab} setActiveTab={setActiveTab} />
      <SidebarInset>
